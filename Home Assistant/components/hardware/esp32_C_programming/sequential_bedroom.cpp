...
void loop() {
  ...
  if(Firebase.setFloat(fbData,"/bedroom/sensor/temperature",temp))
  {
  ...
  if(Firebase.setFloat(fbData,"/bedroom/sensor/humidity",humi))
  {
  ...
  if(Firebase.getString(fbData, "/bedroom/device/lights"))
  {
  ...
  if(Firebase.getInt(fbData, "/bedroom/device/lamp")) {
